...
class TwoDTriangle(MovingCameraScene):
    def construct(self):
        ...
        self.play(
            ...
            tick1.animate.set_stroke(opacity=0.1),
            tick1_C.animate.set_stroke(opacity=0.1),
            tick2.animate.set_stroke(opacity=0.1),
            tick2_C.animate.set_stroke(opacity=0.1),
            bn_ticks.animate.set_stroke(opacity=0.1),
            cm_ticks.animate.set_stroke(opacity=0.1),
            dn_ticks.animate.set_stroke(opacity=0.1),
            em_ticks.animate.set_stroke(opacity=0.1),
